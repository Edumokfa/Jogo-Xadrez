...
public class ChessMatch {
    ...
    public ChessPiece replacePromotedPiece(String type) {
        if (promoted == null) {
            throw new IllegalStateException("Não há nenhuma peça para promover");
        }
    ...
    private void validateSourcePosition(Position position) {
        if (!board.thereIsAPiece(position)) {
            throw new ChessException("Não há nenhuma peça nesta posição");
        }
    ...
    private ChessPiece king(Color color) {
        ...
        throw new IllegalStateException("Não há um rei " + color + " na mesa");
    }
